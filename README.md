...
Windows 11 batch script to maximize FPS and the lowest input latency. Tweaks power plan, GPU, CPU scheduling, memory, and disables background services/telemetry.
